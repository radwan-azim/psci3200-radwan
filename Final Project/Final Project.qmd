...
This project investigates how the effect of foreign aid on corruption varies depending on a country's level of democracy. I hypothesize that foreign aid increases corruption in countries with low democracy scores, but decreases corruption in countries with high democracy scores. In other words, the relationship between foreign aid and corruption is conditional on the strength of democratic institutions.

Hypothesis: **Foreign aid reduces corruption in countries with high democracy scores but increases corruption in countries with low democracy scores.**
